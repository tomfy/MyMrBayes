...
#include "utils.h"
       ...
       const char* const svnRevisionBayesC = "$Rev: 967 $";   /* Revision keyword which is expended/updated by svn on each commit/update */
...
int ReinitializeMrBayes (void)
{
    ...
    chainParams.chainTemp = 0.1;                     /* chain temperature spacing                     */
